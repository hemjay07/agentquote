  ...
  return (
    <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-md p-4">
      ...
      <button
        ...
        className="mt-2 w-full bg-[var(--bg-secondary)] border border-[var(--border)] text-[var(--text-primary)] font-medium px-4 py-2 rounded-md hover:border-[var(--accent)] transition-colors disabled:opacity-50 text-sm"
      >
